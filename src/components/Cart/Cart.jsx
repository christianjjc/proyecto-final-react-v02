...
const Cart = () => {
    ...
    const hanldeVaciarCarrito = (event) => !cartCtx.clearProductos() && event.preventDefault();
            ...
            <>
                <div className='my-4'>
                    ...
                    <div className="d-flex justify-content-end pb-4">
                        <Link to={'/'} id="btnVaciarCarrito" className="btn btn-warning"  href="#" onClick={hanldeVaciarCarrito} >
                            Vaciar Carrito
